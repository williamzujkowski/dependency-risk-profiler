...
def test_with_dependabot():
    ...
    has_update_tools, update_tools_score, issues = check_dependency_update_tools(dependency, repo_dir)
    ...
    logger.info(f"Tools found: {dependency.additional_info.get('dependency_update_tools', 'None')}")
