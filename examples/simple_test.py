...
src.dependency_risk_profiler.scorecard.security_policy.check_security_policy = mock_check_function
src.dependency_risk_profiler.scorecard.dependency_update.check_dependency_update_tools = mock_check_function
src.dependency_risk_profiler.scorecard.signed_commits.check_signed_commits = mock_check_function
src.dependency_risk_profiler.scorecard.branch_protection.check_branch_protection = mock_check_function
...
def test_trend_analysis():
    ...
    manifest_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "requirements.txt"))
    ...
    # Print stats
    print(f"  Period analyzed: {trends['analyzed_period']['start']} to {trends['analyzed_period']['end']}")
