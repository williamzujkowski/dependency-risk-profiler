...
def analyze_python_transitive_dependencies(requirements_file: str) -> Dict[str, Set[str]]:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="dependency-risk-profiler-") as temp_dir:
        ...
        # Check Poetry format
            ...
            if "dependencies" in pyproject_data["tool"]["poetry"]:
                ...
                for name, spec in poetry_deps.items():
                    ...
                    elif name != "python" and isinstance(spec, dict) and "version" in spec:
...
def build_dependency_graph(direct_dependencies: List[str], dependency_map: Dict[str, Set[str]]) -> Dict[str, Set[str]]:
...
def analyze_transitive_dependencies_enhanced(
    ...
    try:
        ...
        elif any(manifest_path.endswith(ext) for ext in [
