...
class SecurityMetrics:
    ...
    average_time_to_fix_days: Optional[float] = None  # Average days to fix vulnerabilities
    has_recent_security_update: Optional[bool] = None  # Whether there was a recent security update
