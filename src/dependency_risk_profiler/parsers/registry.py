...
from typing import Callable, Dict, List, Optional, Pattern, Type, Tuple, Any
...
class EcosystemRegistry:
    ...
    @classmethod
    def register_parser(cls, ecosystem_name: str, parser_class: Type[BaseParser], 
                       file_matchers: List[Dict[str, Any]]) -> None:
        ...
        for matcher in file_matchers:
            ...
            cls._file_matchers[ecosystem_name].append((matcher_type, pattern, matcher_fn))
