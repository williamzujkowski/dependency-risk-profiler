...
class TestAsyncVulnerabilitySources:
    ...
    @async_test
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncOSVSource._normalize_results')
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncHTTPClient.post')
    async def test_osv_source_get_vulnerabilities(self, mock_post, mock_normalize, osv_source):
        ...
        # Act
        vulnerabilities = await osv_source.get_vulnerabilities_async(package_name, ecosystem)
    ...
    @async_test
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncNVDSource._normalize_results')
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncHTTPClient.get')
    async def test_nvd_source_get_vulnerabilities(self, mock_get, mock_normalize, nvd_source):
        ...
        # Act
        vulnerabilities = await nvd_source.get_vulnerabilities_async(package_name, ecosystem)
    ...
    @async_test
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncGitHubAdvisorySource._normalize_results')
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncHTTPClient.post')
    async def test_github_source_get_vulnerabilities(self, mock_post, mock_normalize, github_source):
        ...
        # Act
        vulnerabilities = await github_source.get_vulnerabilities_async(package_name, ecosystem)
...
class TestAsyncVulnerabilityAggregation:
    ...
    @async_test
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.AsyncOSVSource.get_vulnerabilities_async')
    ...
    async def test_aggregate_vulnerabilities_for_package(
        ...
        # Act
        updated_dep, vulnerabilities = await aggregate_vulnerabilities_for_package_async(
            test_dependency,
            api_keys={},
            enable_osv=True,
            enable_nvd=False,
    ...
    @async_test
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.aggregate_vulnerabilities_for_package_async')
    ...
    @patch('dependency_risk_profiler.vulnerabilities.aggregator_async.aggregate_vulnerability_data_async_impl')
...
def test_aggregator_async_performance():
    ...
    pytest.skip("Skipping complex performance benchmark - needs real timing and comparison")