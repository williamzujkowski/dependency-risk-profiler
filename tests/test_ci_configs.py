...
def test_github_workflow_yaml_valid():
    ...
    workflow_path = root_dir / "src" / "dependency_risk_profiler" / "secure_release" / "github_actions_ci_cd.yaml"
    ...
    try:
        ...
        assert isinstance(yaml_content, dict), "Workflow YAML should parse as a dictionary"
